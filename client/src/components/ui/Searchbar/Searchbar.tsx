import { ChangeEvent, KeyboardEvent, InputHTMLAttributes, useId } from "react";
...
const Searchbar: React.FC<SearchbarProps> = (props) => {
    const { onChange, className, label, ...rest } = props;
    const id = useId();
    ...
    return (<div className={rootClassName}>
        ...
        <button 
            type="button" 
            onClick={() => props.onKeyDown?.({ key: 'Enter' } as unknown as KeyboardEvent<HTMLInputElement>)}
            className={s.button}>
